...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/glycin_and_loaders-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/glycin_and_loaders-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=28639&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/glycin_and_loaders-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=28639&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/glycin_and_loaders-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-glycin-green.svg)](https://anaconda.org/conda-forge/glycin) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/glycin.svg)](https://anaconda.org/conda-forge/glycin) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/glycin.svg)](https://anaconda.org/conda-forge/glycin) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/glycin.svg)](https://anaconda.org/conda-forge/glycin) |
...
Installing `glycin` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
mamba install glycin glycin-gtk4 glycin-loaders
```
...
pixi add glycin glycin-gtk4 glycin-loaders
# for installing globally
pixi global install glycin glycin-gtk4 glycin-loaders
```
...
It is possible to list all of the versions of `glycin` available on your platform:
...
```
pixi search glycin --channel conda-forge
```
